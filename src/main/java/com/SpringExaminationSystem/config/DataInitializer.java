...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Question> questions = Arrays.asList(
                ...
                createQuestion("Which keyword is used to create an object in Java?", 1, chapter1, Arrays.asList(
                        "new", true,
                        "create", false,
                        "object", false,
                        "instance", false)),
                createQuestion("What is the default value of an int variable in Java?", 1, chapter1, Arrays.asList(
                        "0", true,
                        "null", false,
                        "undefined", false,
                        "-1", false)),
                createQuestion("Which of the following is a primitive data type in Java?", 1, chapter1, Arrays.asList(
                        "String", false,
                        "int", true,
                        "Integer", false,
                        "Object", false)),
                createQuestion("What is inheritance in Java?", 2, chapter2, Arrays.asList(
                        "A mechanism that allows a class to inherit properties and methods from another class", true,
                        "A way to create multiple objects", false,
                        "A method to access private variables", false,
                        "A technique to improve performance", false)),
                createQuestion("Which keyword is used to prevent inheritance in Java?", 2, chapter2, Arrays.asList(
                        "final", true,
                        "static", false,
                        "private", false,
                        "protected", false)),
                createQuestion("What is polymorphism in Java?", 2, chapter2, Arrays.asList(
                        "The ability of different objects to respond to the same method call in different ways", true,
                ...
                createQuestion("Which collection interface extends Iterable?", 3, chapter3, Arrays.asList(
                        "Collection", true,
                        "List", false,
                        "Set", false,
                        "Map", false)),
                createQuestion("What is the difference between ArrayList and LinkedList?", 3, chapter3, Arrays.asList(
                        "ArrayList uses dynamic array, LinkedList uses doubly linked list", true,
                        "ArrayList is faster for insertion, LinkedList is faster for access", false,
                        "ArrayList can store objects, LinkedList can only store primitives", false,
                        "There is no difference between them", false)),
                createQuestion("Which method is used to add an element to an ArrayList?", 3, chapter3, Arrays.asList(
                        "add()", true,
                        "insert()", false,
                        "append()", false,
                        "push()", false)));
